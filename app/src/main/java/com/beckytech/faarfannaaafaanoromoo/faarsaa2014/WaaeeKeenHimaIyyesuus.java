...
public class WaaeeKeenHimaIyyesuus extends OptionsMenuActivity {
    ...
    String content = "Waa'ee keen hima \n" +
            ...
            "Itti qaana’u gochasaa nan hima\n" +
            ...
            "Yakka koo tarreessee fuldura na dhaabee\n" +
            "Itti murteessitee yakkii diina koo\n" +
            "Beenu nagaan gali nan jedhe Gooftaan koo\n\n" +
            "Akkan si jaalluu ni beekta uumaa koo\n" +
            "Otoon sitti himin beekta hoo keessa koo\n" +
            "Nan hima waa'ee kee maafan callisaa\n" +
            "Hoosa'ina jedhee maqaa kee fan faarsaa\n";

    String title = "Waa'ee keen hima Iyyesuus";
