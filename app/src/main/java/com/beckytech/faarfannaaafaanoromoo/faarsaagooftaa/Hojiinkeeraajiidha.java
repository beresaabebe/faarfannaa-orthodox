...
public class Hojiinkeeraajiidha extends OptionsMenuActivity {

    TextView textTitle, textContent;

    String content = "Hojiin kee raajiidha bahaa hamma lixaatti\n" +
    ...
    String title = " Hojiin kee raajiidha bahaa hamma ";
