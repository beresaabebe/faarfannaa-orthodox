...
public class MaalNamaGootee extends OptionsMenuActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;
    String mezmur = "Maal nama gootee Maariyaamii Maal nama gooteex2\n" +
            "Homaayyuu!\n" +
            "Fayyisaa keenyaa nuuf deessee malee x2\n" +
            "Maal nama gootee Maariyaamii x2\n" +
            "Maal nama godhee Mikaa’eel Maal nama godhee x2\n" +
            "Homaayyuu!\n" +
            "Seexana jalaa nu baase malee\n" +
            "Maal nama godhee Mikaa’eel x2\n" +
            "Maal nama godhee Gabri’eel Maal nama godhee \n" +
            "Homaayyuu!\n" +
