...
public class Yoordaanoosii extends OptionsMenuActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;

    String mezmur = "Ishoo kaa Gooftaan nuuf cuuphame (4) \n" +
            ...
            "Yordaanosii(2) Eyyee \n" +
            "Dhaala Gooftaa kan waaqayyoo \n" +
            "Si filatee gooftaan kunoo\n" +
            " \n" +
            "Nuuf Cuuphame waaqayyoonii \n" +
