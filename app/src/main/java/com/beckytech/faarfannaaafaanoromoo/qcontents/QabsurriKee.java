package com.beckytech.faarfannaaafaanoromoo.qcontents;
...
public class QabsurriKee extends AppCompatActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;
    String mezmur = "Qabsurrii Kee Addaa dubbanne hin fixnuu \n" +
