...
public class AmmaIfatuuNuufActivity extends OptionsMenuActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;
    String mezmur = "Amma  ifatuu nuuf ba’ee   (2)\n" +
            "Durbeerraa dhalatee Fayyina nuuf ta'ee \n" +
            "\tCeesisa\n"+
            "Samiirraa gad bu’ee Addaamiin barbaadee(2)\n" +
            "Taayitaa isaa jalqabaatti deebisuudhaaf jedhee\n" +
            "\tCeesisa\n"+
            "Lubbuu isheerraa lubbuu foon isheerraa hirmaatee(2)\n" +
            "Fannifamuu isaatiin du’a nu olfatee\n" +
            "\tCeesisa\n"+
            "Dureessaas yoo ta’uu kan danda’uu hundumaa(2)\n" +
