package com.beckytech.faarfannaaafaanoromoo.ucontents;
...
public class UlfinaToloota extends AppCompatActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;

    String mezmur = "Ulfina tolootaa yaa Giiftii(2) ulfina tolootaa\n" +
            "Leemmatii nyaata raajiidha leemmatii nyaata(2)\n" +
            "\t\tCeesisa\n" +
            "Kabaja isaanii kan Qulqullootaa\n" +
            "Sin faarsaa ani faarsaa galataa\n" +
            "Kan ati nuf deesse buddeen jireenyaa\n" +
            "Bokkaa kan qanduu duumessa xiqqoo \n" +
            "\t\tCeesisa\n" +
            "Huccuu Gaarummaa miidhaginni ishee\n" +
            "Ulfa sochoosa qooqni afaan ishee\n" +
            "Abidda deessee abidda haammattee\n" +
            "Osoo si hin faarsiin aduun yoom dhiitee\n" +
            "\t\tCeesisa\n" +
            "Yaa baha biiftuu baha nuuf taatee\n" +
            "Ificha guddaa kan nuuf muul’istee\n" +
            "Hin dukkanooftu jireenyi keenyaa\n" +
            "Ilmi kee jira ifichi keenyaa \n" +
            "\t\tCeesisa\n" +
            "Nagaan siif haa ta’u nuti si kadhannaa\n" +
            "Ati nuuf kadhadhu nuti sitti boonyaa \n" +
