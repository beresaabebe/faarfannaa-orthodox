package com.beckytech.faarfannaaafaanoromoo.tcontents;
...
public class TokkummaaNuufKenni extends AppCompatActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;

    String mezmur = "Tokkummaa nuuf kenni  ya Gooftaa yaadan tokko taanaa (2)\n" +
