package com.beckytech.faarfannaaafaanoromoo.rcontents;
...
public class RaajiiGiyoorgisii extends AppCompatActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;
    String mezmur = "Rajii Giyoorgisii(3x) Eyyee\n" +
            "Qilleensaarraa ka'ee ofi mullisee (2x) Eyyee\n" +
            "Foon isa muran abiddaas busaan\n" +
            "Mooyyeetis Tumaani Eyyee\n" +
            "Afuufanii qilleensaf Laatan(2x) Eyyee\n";

    String mezmurTitle = "Raaajii giyoorgisii";
