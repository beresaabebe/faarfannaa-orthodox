...
public class DamaraaWalitti extends OptionsMenuActivity {
    ...
    String content = "Damaraa Walitti qabaa muka bobeessa \n" +
            ...
            "Kan gooftaa Iyyesuus irratti dhiphate bara dheeraadhaaf badee dhokatee \n" +
            "Mootittii Illeeniitu Mul’ataan argatte/2\n";

    String title = " Damaraa Walitti  ";
