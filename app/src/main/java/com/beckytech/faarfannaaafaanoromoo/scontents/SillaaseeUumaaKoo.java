...
public class SillaaseeUumaaKoo extends AppCompatActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;

    String mezmur = "Sillaasee uumaa koo(6) Eeyyee\n" +
            "Akka mana Abrahaam(2) \n" +
            "Eebbisi mana koo\n" +
            "\t\tCeesisa\n" +
            "Giiftii maariyaam (6) Eeyyee\n" +
            "Naa gargaarii Maaloo(2) \n" +
            "Yaa haadha Garramii\n" +
            "\t\tCeesisa\n" +
            "Haadha koo Arseemaa (6) Eeyyee\n" +
            "Ati naaf kadhadhu(2) \n" +
