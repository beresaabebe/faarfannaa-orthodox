...
public class SiGalateeffanna extends AppCompatActivity {

    TextView textView, textTitle;
    FloatingActionButton fabShare;

    String mezmur = "Si galateeffanna Dubroo Maariyaamii \n" +
            "Abdii waan nu taateef akka kufnee hin hafnee(2×)eyyeen \n" +
